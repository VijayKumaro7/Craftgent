...
from app.api import health, chat, auth_router, ws_router, stats_router, sessions_router, files_router, agents_router, reports_router
...
def create_app() -> FastAPI:
    ...
    app.add_middleware(
        ...
        allow_methods=["GET", "POST", "DELETE", "OPTIONS"],  # Restrict to necessary methods only
